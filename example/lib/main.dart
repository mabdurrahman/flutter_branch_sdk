...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    if (kIsWeb) {
      FlutterBranchSdk.initWeb(branchKey: 'key_test_ipQTteg11ENANDeCzSXgqdgfuycWoXYH');
    } else {
  ...
  void initDeepLinkData() {
    metadata = BranchContentMetaData()
      ...
      4,
      5,
    ]).addCustomMetadata('custom_list_string', [
      'a',
      'b',
      'c',
    ]);
...
*/
                  ...
                  Expanded(
                    child: CustomButton(
                      ...
                      onPressed: () async {
                        ...
                        bool success = await FlutterBranchSdk.listOnSearch(
                          buo: buo,
                        );
                  ...
                  Expanded(
                    child: CustomButton(
                      ...
                      onPressed: () async {
                        ...
                        bool success = await FlutterBranchSdk.removeFromSearch(
                          buo: buo,
                        );
  ...
  void shareLink() async {
    ...
    if (response.success) {
      showSnackBar(
        context: context,
        message: 'showShareSheet Sucess',
        duration: 5,
      );
    } else {
      showSnackBar(
        context: context,
        message: 'showShareSheet Error: ${response.errorCode} - ${response.errorMessage}',
        duration: 5,
      );
    }
  }
